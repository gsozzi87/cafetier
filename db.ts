...
export function initDB() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS products (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      name TEXT NOT NULL, origin_id INTEGER, variety_id INTEGER, roast_profile_id INTEGER,
    ...
    CREATE TABLE IF NOT EXISTS order_items (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      order_id INTEGER NOT NULL, product_id INTEGER, product_name TEXT,
    ...
    CREATE TABLE IF NOT EXISTS order_payments (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      order_id INTEGER NOT NULL, amount REAL NOT NULL,
      payment_method TEXT CHECK(payment_method IN ('efectivo','transferencia','tarjeta')),
      payment_date TEXT DEFAULT (datetime('now')), notes TEXT, registered_by TEXT,
      FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE CASCADE
    );
    CREATE TABLE IF NOT EXISTS order_shipments (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      order_id INTEGER NOT NULL, shipment_date TEXT DEFAULT (datetime('now')),
      kg_shipped REAL NOT NULL, destination_address TEXT, carrier TEXT,
      tracking_number TEXT, shipping_cost REAL DEFAULT 0, notes TEXT, registered_by TEXT,
      FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE CASCADE
    );
    CREATE TABLE IF NOT EXISTS roasting_sessions (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      session_date TEXT DEFAULT (date('now')), operator TEXT NOT NULL,
      notes TEXT, created_at TEXT DEFAULT (datetime('now'))
    );
    CREATE TABLE IF NOT EXISTS roasting_batches (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      session_id INTEGER NOT NULL, batch_number TEXT NOT NULL,
      ...
      ai_analysis TEXT, artisan_file_path TEXT, artisan_file_name TEXT,
      machine_hours REAL DEFAULT 0, notes TEXT,
      created_at TEXT DEFAULT (datetime('now')),
    ...
    CREATE TABLE IF NOT EXISTS packaging (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      batch_id INTEGER NOT NULL, packaging_date TEXT DEFAULT (date('now')),
    ...
    CREATE TABLE IF NOT EXISTS inventory (
      ...
      origin_id INTEGER, variety_id INTEGER, batch_id INTEGER, lot_label TEXT, notes TEXT,
      FOREIGN KEY (origin_id) REFERENCES origins(id),
      FOREIGN KEY (variety_id) REFERENCES varieties(id),
    ...
    CREATE TABLE IF NOT EXISTS inventory_movements (
      ...
      quantity REAL NOT NULL, reason TEXT,
      reference_type TEXT, reference_id INTEGER, registered_by TEXT,
      created_at TEXT DEFAULT (datetime('now')),
      FOREIGN KEY (inventory_id) REFERENCES inventory(id) ON DELETE CASCADE
    );
    CREATE TABLE IF NOT EXISTS expenses (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      expense_date TEXT DEFAULT (date('now')), category_id INTEGER NOT NULL,
      amount REAL NOT NULL, description TEXT, paid_by TEXT NOT NULL,
      lot_label TEXT, supplier TEXT, quantity REAL, quantity_unit TEXT, notes TEXT,
      created_at TEXT DEFAULT (datetime('now')),
      FOREIGN KEY (category_id) REFERENCES expense_categories(id)
    );
    CREATE TABLE IF NOT EXISTS capital_contributions (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      partner_name TEXT NOT NULL, amount REAL NOT NULL, description TEXT,
    ...
    CREATE TABLE IF NOT EXISTS profit_withdrawals (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      partner_name TEXT NOT NULL, amount REAL NOT NULL, month TEXT NOT NULL,
      withdrawal_date TEXT DEFAULT (date('now')), notes TEXT,
      created_at TEXT DEFAULT (datetime('now'))
    );
    CREATE TABLE IF NOT EXISTS machine_log (
      ...
      description TEXT NOT NULL, cost REAL DEFAULT 0, hours REAL DEFAULT 0,
